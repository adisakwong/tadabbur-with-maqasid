...
เว็บแอปพลิเคชันสแตติกสำหรับศึกษาอัลกุรอานแบบ Tadabbur-Maqasid แบ่งหน้าจอเป็น 2 ส่วน: ด้านซ้ายแสดงเนื้อหาจาก quran.com ตามจุดอ่านล่าสุด ด้านขวาแสดงข้อมูล Maqasid / โครงสร้างเป้าประสงค์ทางอัลกุรอานของสูเราะฮ์นั้น
...
### ปุ่มเปิด/ปิดแผนที่
- ปุ่มใน header สำหรับแสดง/ซ่อน panel แผนที่
...
- กด **เปิดแผนที่** เพื่อแสดง panel ขวากลับมา
...
- คุณสามารถอ่าน, เลื่อน, ค้นหา, ฟังเสียงอ่าน, หรือ sign in เพื่อใช้บุ๊กมาร์กและโน้ตได้
- คลิกภายใน panel เพื่อใช้งาน quran.com ได้เต็มที่

### ศึกษา Maqasid
- panel ขวาแสดงข้อมูล Maqasid ของสูเราะฮ์นั้น
- ข้อมูลนี้ช่วยให้เห็นภาพรวมเนื้อหาของสูเราะฮ์ในรูปแบบหัวข้อและเป้าประสงค์ทางอัลกุรอาน
...
| quran_maps/ | ไฟล์ HTML แผนที่ความหมายอายะฮ์ |
